...
try:
    ...
    print("✓ Imported GeminiLLMClient from gemini_llm_client.py")
...
# Initialize additional clients for final summary
try:
...
print(f"  • HuggingFace Model: {hf.get_model_name() if hf is not None else 'N/A'}")
print(f"  • Gemini Model:     {gemini.get_model_name() if gemini is not None else 'N/A'}")
